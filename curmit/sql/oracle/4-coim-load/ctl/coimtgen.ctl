...
TRAILING NULLCOLS
(COD_TGEN                      CHAR(8) NULLIF (COD_TGEN = BLANKS)
...
,COD_PROV                      CHAR(8) NULLIF (COD_PROV = BLANKS)
,COD_COMU                      CHAR(8) NULLIF (COD_COMU = BLANKS)
...
,LINK_CAP                      CHAR(500) NULLIF (LINK_CAP = BLANKS)
