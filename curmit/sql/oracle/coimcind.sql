/*==============================================================*/
/* table coimcind: campagne dichiarazioni                       */
/*==============================================================*/
create table coimcind
     ( cod_cind         varchar2(08)  not null
...
create unique index coimcind_00
    on coimcind
     ( cod_cind
     ) tablespace &ts_idx;

alter table coimcind
  add constraint chk_stato_coimcind
