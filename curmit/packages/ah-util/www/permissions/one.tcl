...
ad_page_contract {
    ...
    @cvs-id $Id: one.tcl,v 1.1.1.1 2014/03/06 15:04:07 nsadmin Exp $
} {
...
set context [list [list "/ah-util/scripts-list" "Lista script"] [ad_quotehtml [_ acs-subsite.Permissions_for_name]]]
...
lappend controls "<a href=\"grant?[export_vars {application_url object_id}]\">Assegna permesso</a>"

db_1row context { *SQL* }

if { $security_inherit_p == "t" && ![empty_string_p $context_id] } {
    lappend controls "<a href=\"toggle-inherit?[export_vars {application_url object_id}]\">Non ereditare permessi da [ad_quotehtml $context_name]</a>"
} else {
    lappend controls "<a href=\"toggle-inherit?[export_vars {application_url object_id}]\">Eredita permessi da [ad_quotehtml $context_name]</a>"
}
