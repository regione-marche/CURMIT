...
<queryset>
  ...
  left outer join coimcomb h
       ...
       <querytext>
           insert
             into coimcimp 
                ( cod_cimp
                , cod_impianto
		, rapp_cont_inviato  --rom01
		, rapp_cont_bollino  --rom01
		, int_rend_term      --rom01
		, int_rend_term_note --rom01
                , gen_prog
                , cod_inco
                , data_controllo
                , cod_opve
    ...
    <partialquery name="upd_aimp_installaz">
       <querytext>
           update coimaimp
              set data_installaz = :aimp_data_installaz
                 ,cod_tpdu       = :cod_tpdu
                 ,cod_tpim       = :cod_tpim
                 ,cod_cted     = :cod_cted
            where cod_impianto   = :cod_impianto
    ...
    <partialquery name="upd_cimp">
       <querytext>
		...
		, rapp_cont_inviato         = :rapp_cont_inviato  --rom01
		, rapp_cont_bollino         = :rapp_cont_bollino  --rom01
		, int_rend_term             = :int_rend_term      --rom01
		, int_rend_term_note        = :int_rend_term_note --rom01		
                , cod_opve                  = :cod_opve
                , costo                     = :costo
		...
		, fl_rifiuto_firma          = :fl_rifiuto_firma    
                ...
                , interna_locale_idoneo     = :interna_locale_idoneo 
    ...
    <fullquery name="sel_cimp">
       <querytext>
           select a.gen_prog
                ...
                , a.cod_opve
		, a.rapp_cont_inviato --rom01
		, a.rapp_cont_bollino --rom01
		...
		, fl_rifiuto_firma 
	        ...
	        , a.auto_adeg_152
                ...
                , ass_perdite_comb
		, p.cod_impianto_est
		, p.localita as localita
		, p.toponimo || p.indirizzo as indirizzo
		, comu.denominazione as descr_comune
		, a.int_rend_term
		, a.int_rend_term_note
  	     from coimcimp a
 $join_movi
 left outer join coimcitt c on c.cod_cittadino = a.cod_responsabile
 left outer join coimaimp p on p.cod_impianto = a.cod_impianto
 left outer join coimcomu comu on comu.cod_comune = p.cod_comune
