...
append stampa "
 ...
 <td><small>
       <table border=1 width=100%>
        <tr bgcolor=#D6D6D6>
          <td colspan=4 align=center valign=top ><b>STATO DELLA DOCUMENTAZIONE</b></td>
        </tr>
        <tr> 
        ...
        <tr>
          <td valign=top align=left width=100%><b>CHECK LIST</b><small> elenco dei possibili interventi dei quali va valutata la convenienza economica, che qualorora applicabili potrebbero comportare un miglioramento delle prestazioni energetiche</small></td>
        </tr>        
        <tr><td valign=top align=left><small>$check_valvole - Adozione di valvole termostatiche sui corpi scaldanti</small></td></tr>
        <tr><td valign=top align=left><small>$check_isolamento - Isolamento della rete di distribuzione nei locali non riscaldati</small></td></tr>
        <tr><td valign=top align=left><small>$check_trattamento - Introduzione di un sistema di trattamento dell'acqua sanitaria e per riscaldamento ove assente</small></td></tr>
        <tr><td valign=top align=left><small>$check_regolazione - Sostituzione di un sistema di regolazione on/off con un sistema programmabile a piu' livelli di temperatura</small></td></tr>
        <tr><td valign=top align=left><small>$check_sostituzione - Sostituzione generatore</small></td></tr>
        <tr><td valign=top align=left><small>$check_scambiatori - Far controllare Scambiatori</small></td></tr>
        <tr><td valign=top align=left><small>$check_eccesso_aria - Far regolare eccesso aria</small></td></tr>
        <tr><td valign=top align=left><small>$check_altro - Altro  Vedi note osservazioni</small></td></tr>
         <tr>
             <td valign=top align=left width=100%><b><small>Stima del dimensionamento del generatore: </b> $dimensionamento_gen</small></td>         </tr>
  <tr></small>
    <td><small>
       <table border=1 width=100%>
        <tr bgcolor=#D6D6D6>
  ...
  <tr>
    <td><small>
      <table border=1 width=100%>
        <tr bgcolor=#D6D6D6>
          <td colspan=6 align=center valign=top><b>MANUTENZIONE ED ANALISI1</b></td>
        </tr>
        <tr>
    ...
    <td>
      <table border=1 width=100% cellpadding=0 cellspacing=0>
        ...
        <tr>
          ...
          <td valign=top align=left width=50%> Rientra nei termini di legge: <b>$esito_verifica</b></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign=bottom align=left>$rend_comb_8d</td>
  ...
  <tr>
    <td><table border=1 width=100%>
        ...
        <td valign=top align=left>Controllato Cucina: $controllo_cucina</td>
        <tr>
  ...
  <tr>
     <td><table border=1 width=100%>
        <tr>
         ...
         <td valign=top  align=left bgcolor=#D6D6D6>pagamento effettuato al momento del controllo</td>
         <td valign=top>$pagamento_effettuato</td>
         </tr>
  ...
  <tr>
        ...
        <tr>
          <td valign=top align=center ><b>12.a) RESPONSABILE IMPIANTO O SUO<br>DELEGATO PER RICEVUTA</b></td>
          <td valign=top align=center ><b>12.b) IL VERIFICATORE</b></td>
        </tr>
        <tr>
