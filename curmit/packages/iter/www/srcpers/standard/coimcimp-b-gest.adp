...
<tr>
    <td><table border=0 width="100%">
        <tr>
            <td colspan=4 align=center valign=top class=func-menu><b>3. VERIFICA LOCALE</b></td>
        </tr>
        <tr>
            <td valign=top width="45%" align=left class=form_title>a) Ubicazione locale conforme alle prescrizioni di legge</td>
            <td valign=top width="5%"align=right width="10%">
                <formwidget id="ubic_locale_norma">
                <formerror  id="ubic_locale_norma"><br>
                <span class="errori">@formerror.ubic_locale_norma;noquote@</span>
                </formerror>
            </td>
            <td valign=top width="35%" align=left class=form_title>e) Interruttore generale esterno presente <font color=red>*</font></td>
        ...
        <tr>
	<tr>
	    <td valign=top align=left class=form_title>b) Sistema di areazione del locale sufficiente <font color=red>*</font></td>
            ...
            <td valign=top align=left class=form_title>f) Assenza di materiali estranei alla centrale <font color=red>*</font></td>
            <td valign=top align=right >
                <formwidget id="new1_asse_mate_estr">
                <formerror  id="new1_asse_mate_estr"><br>
                <span class="errori">@formerror.new1_asse_mate_estr;noquote@</span>
                </formerror>
            </td>            
        </tr> 
        <tr>
            <td valign=top align=left class=form_title>c) Accesso alla centrale conforme alle prescrizioni di legge <font color=red>*</font></td>
            <td valign=top align=right >
                <formwidget id="new1_conf_accesso">
                <formerror  id="new1_conf_accesso"><br>
                <span class="errori">@formerror.new1_conf_accesso;noquote@</span>
                </formerror>
            </td>
        ...
        <tr>
            <td valign=top align=left class=form_title>d) Rubinetto di intercettazione manuale esterna presente <font color=red>*</font></td>
            <td valign=top align=right >
            ...
            <td valign=top align=left class=form_title>h) Cartellonistica prevista presente <font color=red>*</font></td>
            <td valign=top align=right >
...
<tr>
    <td><table border=0 width="100%">
        ...
        <tr>
            <td valign=top width="45%" align=left class=form_title>a) Libretto della centrale termica presente <font color=red>*</font></td>
            <td valign=top width="5%"align=right width="10%">
            ...
            <td valign=top width="35%" align=left class=form_title>b) Compilazione libretto di centrale completa</td>
            <td valign=top width="15%" align=right><formwidget id="libretto_corretto">
        ...
        <tr>
            ...
            <td valign=top align=left class=form_title>c) Libretto/i di uso e manutenzione caldaia/e presente/i</td>
            <td valign=top align=right >
            ...
            <td valign=top align=left class=form_title>d) Libretto/i di uso e manutenzione bruciatore/i presente/i</td>
            <td valign=top align=right>
                <formwidget id="libr_manut_bruc">
                <formerror  id="libr_manut_bruc"><br>
                <span class="errori">@formerror.libr_manut_bruc;noquote@</span>
                </formerror>
            </td>
        </tr>

        </tr> 
            <td valign=top align=left class=form_title>e) Dichiarazione di conformit&agrave; impianto termico presente</td>
            <td valign=top align=right >
            ...
            <td valign=top align=left class=form_title>f) Dichiarazione di conformit&agrave; impianto elettrico presente</td>
            <td valign=top align=right>
                <formwidget id="conf_imp_elettrico">
                <formerror  id="conf_imp_elettrico"><br>
                <span class="errori">@formerror.conf_imp_elettrico;noquote@</span>
                </formerror>
            </td>
        </tr>
        </tr> 
            <td valign=top align=left class=form_title>g) Denuncia all'ISPESL per generatori in pressione</td>
            <td valign=top align=right >
            ...
            <td valign=top align=left class=form_title>h) Certificato prevenzione incendi per impianti > 116,3 kW</td>
            <td valign=top align=right>
...
<tr>
    <td><table border=0 width="100%">
        <tr>
            <td colspan=4 align=center valign=top class=func-menu><b>5. GENERATORI</b></td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign=top align=left class=form_title>f)Modello e matricola generatore</td>
            <td valign=top align=right class=form_title bgcolor=white>@gend_modello;noquote@ @gend_matricola;noquote@</td>  
            <td valign=top align=left class=form_title nowrap>Campo di funzionamento(kW)</td>
            <td valign=top align=right nowrap>da <formwidget id="campo_funzion_min">
...
<tr>
    <td><table border=0 width="100%">
        ...
        <tr>
            <td  align=left rowspan=2 class=form_title>Rapporto di controllo e manutenzione</td>
...
<tr>
    <td><table border=0 width="100%">
        <tr>
            <td colspan=6 align=center valign=top class=func-menu><b>6B. DOCUMENTAZIONE  art. 284</b></td>
        </tr>
        <tr>
            <td valign=top width="15%" align=right class=form_title>a) Presente/Assente</td>
            <td valign=top width="15%" align=left><formwidget id="flag_pres_284">
                <formerror  id="flag_pres_284"><br>
                <span class="errori">@formerror.flag_pres_284;noquote@</span>
                </formerror>
            </td>
            <td valign=top width="15%" align=right class=form_title>b) Data Documento</td>
            <td valign=top width="15%" align=left><formwidget id="data_284">
                <formerror  id="data_284"><br>
                <span class="errori">@formerror.data_284;noquote@</span>
                </formerror>
            </td>
               <td valign=top width="15%" align=right class=form_title>c) Documento completo</td>
            <td valign=top width="15%" align=left><formwidget id="flag_comp_284">
              <formerror  id="flag_comp_284"><br>
                <span class="errori">@formerror.comp;noquote@</span>
                </formerror>
            </td>
...
<tr>
    ...
    <td valign=top width="50%"><table border=0 width="100%">
        ...
        <tr>
            <td valign=top width="50%" align=left>Anno in corso <font color=red>*</font><br>
