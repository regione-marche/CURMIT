    ...
    <fullquery name="sel_gend">
       <querytext>
           select a.gen_prog_est       as gend_gen_prog_est
                ...
                , iter_edit_data(a.data_installaz) as gend_data_installaz
                , case a.tipo_foco
                     when 'A' then 'Aperto'
                     when 'C' then 'Chiuso'
                     else 'Non Noto'
                ...
                , iter_edit_data(a.data_installaz) as gend_data_installazione
       ...
       <querytext>
           select cod_potenza
            ...
            where potenza_min <= :h_potenza
              ...
              and flag_tipo_impianto = :flag_tipo_impianto --rom01 25/01/2019 
       </querytext>
    </fullquery>
       ...
       <querytext>
           update coimcimp
              set cod_inco                  = :cod_inco
                ...
                , scarico_dir_esterno       = :scarico_dir_esterno
                , rend_suff_insuff          = :rend_suff_insuff
                , dichiarato                = :dichiarato
                , et                        = :et
                , data_284                  = :data_284
                , flag_pres_284             = :flag_pres_284
                , flag_comp_284             = :flag_comp_284
    ...
    <fullquery name="sel_cimp">
       <querytext>
           select a.gen_prog
                ...
                , a.scarico_dir_esterno
                , a.rend_suff_insuff
                , a.dichiarato
                , iter_edit_num(a.et,2) as et  
                , iter_edit_data(a.data_284) as data_284
                , a.flag_pres_284
                , a.flag_comp_284
             from coimcimp a
