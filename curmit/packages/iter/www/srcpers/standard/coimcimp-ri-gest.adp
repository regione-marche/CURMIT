...
<!--
    USER  DATA       MODIFICHE
    ===== ========== ==========================================================================
    sim00 15/10/2020 Le modifiche rom01 e rom02 erano state inizialmente pensate solo per la 
    sim00            Regione Marche ma sono state portate anche su tutti i clienti successivi.
    sim00            Di conseguenza diventeranno lo standard per tutti gli enti. 
    sim00            Tengo traccia per memo futura che sulla Regione Marche sono poi stati messi
    sim00            sotto le loro cartelle dei personalizzati perchè ulteriormente modificati.

    rom02 07/03/2019 Modifiche su label e diciture richieste da Autorita' comptenti e Ispettori
    rom02            della Regione Marche.

    rom01 27-06-2018 Intervento sui link da visualizzare o meno a seconda del tipo utente richiesto
    rom01            dalle Marche.
			...
			<formwidget   id="flag_cimp">
			  <formwidget   id="extra_par_inco">
					...
					<tr>
					  ...
					  <td><table border=0 width="100%">
						  ...
						  <formwidget id="new1_pres_cartell">
						    <formerror  id="new1_pres_cartell"><br>
						      <span class="errori">@formerror.new1_pres_cartell;noquote@</span>
                                                ...
                                                <td valign=top align=left class=form_title>Mezzi di estinzione degli incendi presenti e revisionati <font color=red>*</font></td>
						<td valign=top align=right >
						  ...
						  <formwidget id="new1_pres_intercet">
						    <formerror  id="new1_pres_intercet"><br>
						      <span class="errori">@formerror.new1_pres_intercet;noquote@</span>
                                               ...
                                               <tr>       
						<td valign=top width="35%" align=left class=form_title>Assenza perdite combustibile(esame visivo)</td>
						<td valign=top width="15%" align=right >
						  <formwidget id="ass_perdite_comb">
						...
						<td valign=top align=right>
					      ...
					      <tr>
						<td valign=top align=left class=form_title>Verifica dispositivo di regolazione e controllo Temp Amb.</td>
				...
				<td>
 				<table border=0 width="100%">	
				  <tr>
  	                   <!--rom02<td colspan=6 align=center valign=top class=func-menu><b>5. CONSIGLI EFFICIENTAMENTO</b></td>-->
				    <td colspan=6 align=center valign=top class=func-menu><b>5. INTERVENTI DI MIGLIORAMENTO ENERGETICO DELL'IMPIANTO</b></td><!--rom02-->
					      </tr>
							...
							<formwidget id="check_regolazione">
							  <formerror  id="check_regolazione"><br>
							    <span class="errori">@formerror.check_regolazione;noquote@</span>
                                                ...
                                                <tr>
                                                     <td valign=top align=left>Sostituzione Generatore
							<formwidget id="check_sostituzione">
							  <formerror  id="check_sostituzione"><br>
							    <span class="errori">@formerror.check_sostituzione;noquote@</span>
							  </formerror>
						      </td>
						</tr>
                                                <tr>
                                                     <td valign=top align=left>Far controllare scambiatori
							<formwidget id="check_scambiatori">
							  <formerror  id="check_scambiatori"><br>
							    <span class="errori">@formerror.check_scambiatori;noquote@</span>
							  </formerror>
						      </td>
						</tr>
                                               <tr>
                                                     <td valign=top align=left>Far regolare eccesso aria
							<formwidget id="check_eccesso_aria">
							  <formerror  id="check_eccesso_aria"><br>
							    <span class="errori">@formerror.check_eccesso_aria;noquote@</span>
							  </formerror>
						      </td>
						</tr>
                                               <tr>
                                                     <td valign=top align=left>Altro (vedi osservazioni)
							<formwidget id="check_altro">
							  <formerror  id="check_altro"><br>
							    <span class="errori">@formerror.check_altro;noquote@</span>
							  </formerror>
						      </td>
						</tr>
					...
					<tr>
					  ...
					  <table border=0 width="100%">
                                              <tr>
                                                <td colspan=6 align=center valign=top class=func-menu><b>6. GENERATORI</b></td>
                                              </tr>
					      <tr>
						...
						<td valign=top align=right><formwidget id="gend_data_installaz_v">
					       ...
					       <tr>
				       <!--rom02<td valign=top align=left class=form_title>Tipo caldaia</td>-->
				    <!--rom02--><td valign=top align=left class=form_title>Tipologia gruppo termico</td>
				        ...
				        <!--rom02<td valign=top align=left class=form_title>Tiraggio</td>-->
				     <!--rom02--><td valign=top align=left class_form_title>Modalita&grave; di evacuazione fumi</td>
					...
					<tr>
					  <td><table border=0 width="100%">
                                                  <tr>
                                                <td colspan=6 align=center valign=top class=func-menu><b>7. MANUTENZIONI</b></td>
                                              </tr>
						    <tr>
					...
					<tr>
					  <td><table border=0 cellpadding=0 cellspacing=0 width="100%">
					      <tr>
						<td colspan=5 align=center valign=top class=func-menu><b>8. MISURA DEL RENDIMENTO DI COMBUSTIONE (UNI 10389)</b></td>
					      </tr>
					      <tr>
						<td colspan=5 >&nbsp;</td>
					      </tr>
...
<!--					      <tr>
					...
					<tr>
					  <td colspan=5><table border=0 width="100%">
						...
						<td colspan=2 align=center valign=top class=func-menu><b>10. OSSERVAZIONI DEL VERIFICATORE</b></td>
                                                ...
                                                <td valign=top  align=left class=form_title> Controllato Cucina
							<formwidget id="controllo_cucina">
							  <formerror  id="controllo_cucina">
						...
						<td width="26%" valign=top ><formwidget id="deve_non_rcee">
						    <formerror  id="deve_non_rcee"><br>
						      <span class="errori">@formerror.deve_non_rcee;noquote@</span>
                                              ...
                                              <tr>
                                                <td valign=top align=right class=form_title>L'impianto PUO' Rimanere in funzione</td>
						<td valign=top ><formwidget id="rimanere_funzione">
						    <formerror  id="rimanere_funzione"><br>
						      <span class="errori">@formerror.rimanere_funzione;noquote@</span>
                                                ...
                                                <td valign=top align=right class=form_title>Pagamento effettuato prima del controllo</td>
					...
					<table width=100% border=0>
					  <tr>
						...
						<if @vis_desc_ver@ eq f>
                                                <td valign=top align=right><formwidget id="esito_verifica">
                                                            <formerror  id="esito_verifica"><br>
                                                              <span class="errori">@formerror.esito_verifica;noquote@</span>
                                                            </formerror>
                                                </td>
                                                ...
                                                <else>
                                                <td valign=top align=right><formwidget id="text_esito_verifica">
                                                           <formerror  id="text_esito_verifica"><br>
                                                              <span class="errori">@formerror.text_esito_verifica;noquote@</span>
                                                            </formerror>
                                                </td>
