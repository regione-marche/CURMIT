...
<!--
    USER  DATA       MODIFICHE
    ===== ========== =======================================================================
    gac01 08/05/2018 Aggiunti nuovi campi
    ...
    <fullquery name="sel_dimp_si_vie">
       <querytext>
                      select
                       ...
                       ,iter_edit.num(j.potenza,2)       as potenza
		       ,a.cod_combustibile
                       ,b.cod_cost
                       ,c.descr_cost
                       ,b.modello
		       ...
		       ,d.numero    as numero_resp
                       ...
                       ,d.cap as cap_resp
                       ,d.telefono as telefono_resp --sim01
		       ,a.cod_occupante
		       ...
		       ,e.numero    as numero_util
                       ...
                       ,iter_edit.num(j.co,2) as co --sim01
                       --sim01 ,j.co
                       ...
                       ,j.rct_riflussi_comb         
                       ,j.rct_uni_10389             
                       ,iter_edit.num(j.rct_rend_min_legge,2) as rct_rend_min_legge
                       ...
                       ,j.cod_opmanu_new
                       ,iter_edit.num(j.consumo_annuo2,2) as consumo_annuo2          --gac01
                       ,j.stagione_risc                                              --gac01
                       ,j.stagione_risc2                                             --gac01
                       ,iter_edit.num(j.acquisti,2) as acquisti                      --gac01
                       ,iter_edit.num(j.acquisti2,2) as acquisti2                    --gac01
                       ,iter_edit.num(j.scorta_o_lett_iniz,2) as scorta_o_lett_iniz  --gac01
                       ,iter_edit.num(j.scorta_o_lett_iniz,2) as scorta_o_lett_iniz2 --gac01
                       ,iter_edit.num(j.scorta_o_lett_fin,2) as scorta_o_lett_fin    --gac01
                       ,iter_edit.num(j.scorta_o_lett_fin2,2) as scorta_o_lett_fin2  --gac01
                       ,iter_edit.num(j.bacharach2,0)as bacharach2                   --gac01
                       ,iter_edit.num(j.bacharach3,0)as bacharach3                   --gac01
                       ,iter_edit.num(j.portata_comb,2) as portata_comb              --gac01
                       ,j.rispetta_indice_bacharach                                  --gac01
                       ,j.co_fumi_secchi                                             --gac01
                       ,j.rend_magg_o_ugua_rend_min                                  --gac01
		  from coimdimp j
                     , coimgend b 
                     , coimcost c 
                     , coimaimp a                       
		   ...
		   and b.cod_impianto  (+)= j.cod_impianto
                   ...
                   and k.cod_cittadino (+)= a.cod_proprietario
    ...
    <fullquery name="sel_dimp_no_vie">
       <querytext>
			...
			nvl(a.numero,'')||' '||
                       ...
                       ,iter_edit.num(j.o2,2) as o2
                       ,iter_edit.num(j.co2,2) as co2
                       ,iter_edit.num(j.bacharach,0) as bacharach
