...
<queryset>
    ...
    <partialquery name="upd_anom">
       <querytext>
                update coimanom
                   set dat_utile_inter = :dat_utile_inter
    ...
    <fullquery name="sel_anom">
       <querytext>
             select a.cod_cimp_dimp
                  , a.prog_anom
                  , a.cod_tanom
                  , iter_edit.data(a.dat_utile_inter) as dat_utile_inter
    ...
    <fullquery name="sel_prog">
       <querytext>
            select nvl(max(to_number(prog_anom, '99999990') ),0) + 1 as prog_anom
              from coimanom
             where cod_cimp_dimp = :cod_cimp_dimp
       </querytext>
    </fullquery>
