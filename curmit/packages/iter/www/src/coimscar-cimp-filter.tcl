...
set button_label "Scarica rapporti di ispezione" 
set page_title   "Parametri per scarico rapporti di ispezione"
...
#ns_log notice "prova dob coimscar-cimp-filter link_list = $link_list"

    set return_url "coimscar-cimp-gest?$link_list"
