...
<queryset>
    ...
    <fullquery name="sel_relg">
       <querytext>
           select iter_edit_data(data_rel) as data_rel
                , ente_istat
                , resp_proc
                , iter_edit_num(nimp_tot_stim_ente, 0)     as nimp_tot_stim_ente
                ...
                , conf_dgr7_7568
                , iter_edit_num(npiva_ader_conv, 0)        as npiva_ader_conv
                , iter_edit_num(npiva_ass_acc_reg, 0)      as npiva_ass_acc_reg
                , delib_autodic
                ...
                , iter_edit_num(ntot_autodic_perv, 0)      as ntot_autodic_perv
                , iter_edit_num(ntot_prescrizioni, 0)      as ntot_prescrizioni
                , iter_edit_num(n_ver_interni, 0)          as n_ver_interni
                , iter_edit_num(n_ver_esterni, 0)          as n_ver_esterni
                , iter_edit_num(n_accert_enea, 0)          as n_accert_enea
                , iter_edit_num(n_accert_altri, 0)         as n_accert_altri
                , nome_file_gen
                , nome_file_tec
             from coimrelg
            where cod_relg = :cod_relg
    ...
    <fullquery name="sel_dual_data_rel_fine">
        <querytext>
            select to_char(  to_date(:data_rel_iniz,'yyyymmdd')
                           + interval '2 years'
                           - interval '1 days'
                          , 'yyyymmdd')
       </querytext>
  ...
  left outer join coimanom d    on d.cod_cimp_dimp = a.cod_cimp
