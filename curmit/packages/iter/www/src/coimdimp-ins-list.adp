...
<tr>
   <if @cod_as_resp@ not nil>
   <td width="25%" nowrap class=func-menu>
       <a href=coim_as_resp_admin-list?@link_filter;noquote@ class=func-menu>Ritorna</a>
   </td>
   </if>
   <else>
   <td width="25%" nowrap class=func-menu>
       <a href=coimdimp-ins-filter?@link_filter;noquote@ class=func-menu>Ritorna</a>
   </td>
   </else>
