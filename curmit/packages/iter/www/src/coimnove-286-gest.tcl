...
set titolo              "dichiarazione art.286 D. Lgs. 152/2006"
...
element create $form_name n_generatori_marche \
    ...
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 50 readonly {} class form_element" \
    -optional
...
element create $form_name potenza_utile \
    ...
    -widget   text \
    -datatype text \
    -html    "size 10 maxlength 50 readonly {} class form_element" \
    -optional
...
element create $form_name indirizzo_impianto \
    ...
    -widget   text \
    -datatype text \
    -html    "size 60 maxlength 60 readonly {} class form_element" \
    -optional
...
element create $form_name polveri_totali \
    -label   "polveri_totali" \
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 5 $readonly_fld {} class form_element" \
    -optional

element create $form_name monossido_carbonio \
    -label   "monossido_carbonio" \
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 5 $readonly_fld {} class form_element" \
    -optional

element create $form_name ossidi_azoto \
    -label   "ossidi_azoto" \
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 5 $readonly_fld {} class form_element" \
...
element create $form_name ossidi_zolfo \
    -label   "ossidi_zolfo" \
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 5 $readonly_fld {} class form_element" \
...
element create $form_name carbonio_organico_totale \
    -label   "carbonio_organico_totale" \
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 5 $readonly_fld {} class form_element" \
    -optional

element create $form_name composti_inorganici_cloro \
    -label   "composti_inorganici_cloro" \
    -widget   text \
    -datatype text \
    -html    "size 5 maxlength 5 $readonly_fld {} class form_element" \
    -optional
...
element create $form_name flag_uni_13284 \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_uni_14792 \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_uni_15058 \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_uni_10393 \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_uni_12619 \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_uni_1911 \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_elettrochimico \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
element create $form_name flag_normativa_previgente \
    -label   "check" \
    -widget   checkbox \
    -datatype text \
    -html    "$disabled_fld {} class form_element" \
...
if {[form is_request $form_name]} {
	...
	ad_returnredirect [ad_conn package_url]src/coimaimp-warning?cod_impianto=$cod_impianto&redirect=coimnove-286-gest&$link&funzione=$funzione&caller=$caller
	ad_script_abort    
    }
	...
	element set_properties $form_name polveri_totali            -value $polveri_totali
	element set_properties $form_name monossido_carbonio        -value $monossido_carbonio
	element set_properties $form_name ossidi_azoto              -value $ossidi_azoto
	element set_properties $form_name ossidi_zolfo              -value $ossidi_zolfo
	element set_properties $form_name carbonio_organico_totale  -value $carbonio_organico_totale
	element set_properties $form_name composti_inorganici_cloro -value $composti_inorganici_cloro
	element set_properties $form_name flag_uni_13284            -value $flag_uni_13284
	element set_properties $form_name flag_uni_14792            -value $flag_uni_14792
	element set_properties $form_name flag_uni_15058            -value $flag_uni_15058
	element set_properties $form_name flag_uni_10393            -value $flag_uni_10393
	element set_properties $form_name flag_uni_12619            -value $flag_uni_12619
	element set_properties $form_name flag_uni_1911             -value $flag_uni_1911
	element set_properties $form_name flag_elettrochimico       -value $flag_elettrochimico
	element set_properties $form_name flag_normativa_previgente -value $flag_normativa_previgente
...
if {[form is_valid $form_name]} {
    ...
    set polveri_totali             [element::get_value $form_name polveri_totali]
    set monossido_carbonio         [element::get_value $form_name monossido_carbonio]
    set ossidi_azoto               [element::get_value $form_name ossidi_azoto]
    set ossidi_zolfo               [element::get_value $form_name ossidi_zolfo]
    set carbonio_organico_totale   [element::get_value $form_name carbonio_organico_totale]
    set composti_inorganici_cloro  [element::get_value $form_name composti_inorganici_cloro]
    set flag_uni_13284         [element::get_value $form_name flag_uni_13284]
    set flag_uni_14792         [element::get_value $form_name flag_uni_14792]
    set flag_uni_15058         [element::get_value $form_name flag_uni_15058]
    set flag_uni_10393         [element::get_value $form_name flag_uni_10393]
    set flag_uni_12619         [element::get_value $form_name flag_uni_12619]
    set flag_uni_1911          [element::get_value $form_name flag_uni_1911]
    set flag_elettrochimico        [element::get_value $form_name flag_elettrochimico]
    set flag_normativa_previgente  [element::get_value $form_name flag_normativa_previgente]
	...
	if {![string equal $polveri_totali ""]} {
	    set polveri_totali [iter_check_num $polveri_totali 2]
	    if {$polveri_totali == "Error"} {
		element::set_error $form_name polveri_totali "deve essere numerico con due decimali"
		incr error_num
	    }
	}
	if {![string equal $monossido_carbonio ""]} {
	    set monossido_carbonio [iter_check_num $monossido_carbonio 2]
	    if {$monossido_carbonio == "Error"} {
		element::set_error $form_name monossido_carbonio "deve essere numerico con due decimali"
		incr error_num
	    }
	}
	if {![string equal $ossidi_azoto ""]} {
	    set ossidi_azoto [iter_check_num $ossidi_azoto 2]
	    if {$ossidi_azoto == "Error"} {
		element::set_error $form_name ossidi_azoto "deve essere numerico con due decimali"
		incr error_num
	    }
	}
	if {![string equal $ossidi_zolfo ""]} {
	    set ossidi_zolfo [iter_check_num $ossidi_zolfo 2]
	    if {$ossidi_zolfo == "Error"} {
		element::set_error $form_name ossidi_zolfo "deve essere numerico con due decimali"
		incr error_num
	    }
	}
	if {![string equal $carbonio_organico_totale ""]} {
	    set carbonio_organico_totale [iter_check_num $carbonio_organico_totale 2]
	    if {$carbonio_organico_totale == "Error"} {
		element::set_error $form_name carbonio_organico_totale "deve essere numerico con due decimali"
		incr error_num
	    }
	}
	if {![string equal $composti_inorganici_cloro ""]} {
	    set composti_inorganici_cloro [iter_check_num $composti_inorganici_cloro 2]
	    if {$composti_inorganici_cloro == "Error"} {
		element::set_error $form_name composti_inorganici_cloro "deve essere numerico con due decimali"
		incr error_num
	    }
	}
 ...
 if {$funzione == "I"} {
  ...
  if {$error_num > 0} {
    ...
    set link_gest      [export_url_vars cod_impianto cod_noveb nome_funz nome_funz_caller url_list_aimp url_aimp extra_par caller]
    switch $funzione {
        M {set return_url   "coimnove-286-gest?funzione=V&$link_gest"}
        D {set return_url   "coimdimp-list?$link_list"}
        I {set return_url   "coimnove-286-gest?funzione=V&$link_gest"}
