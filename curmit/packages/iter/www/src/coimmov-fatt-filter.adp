...
<tr>
    ...
    <td valign=top colspan=3 nowrap class=form_title><formwidget id="f_id_caus">
...
<tr>
    ...
    <td valign=top colspan=3 nowrap><formwidget id="data_fattura">
        <formerror  id="data_fattura"><br>
        <span class="errori">@formerror.data_fattura;noquote@</span>
        </formerror>
    </td>
</tr>
