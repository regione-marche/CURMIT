...
set link_gest [export_url_vars cod_impianto last_cod_impianto nome_funz nome_funz_caller extra_par caller url_aimp url_list_aimp]
...
if {[form is_valid $form_name]} {
  ...
  # dopo l'inserimento posiziono la lista sul record inserito
    set return_url   "coimrift-list?$link_list"
