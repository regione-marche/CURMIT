...
<!--
    USER  DATA       MODIFICHE
    ===== ========== =======================================================================
    rom07 15/06/2021 Corretto problema sul calcolo della data in fase di modifica, se la mettevano a mano non veniva
    rom07            tenuta in considerazione e si calcolava automaticamente.
    ...
    <partialquery name="upd_dimp">
       <querytext>
		     ...
		     , data_arrivo_ente   = :data_arrivo_ente
                     ...
                     , data_scadenza        = :data_scadenza_autocert --rom07
