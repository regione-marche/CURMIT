...
<tr>
   <td width="25%" nowrap class=func-menu>
       <a href=coimdist-list?@link_list;noquote@ class=func-menu>Ritorna</a>
   </td>
   <if @funzione@ eq "I">
   ...
   <else>
      <td width="25%" nowrap class=@func_v;noquote@>
         <a href="coimdist-gest?funzione=V&@link_gest;noquote@" class=@func_v;noquote@>Visualizza</a>
      </td>
      <td width="25%" nowrap class=@func_m;noquote@>
         <a href="coimdist-gest?funzione=M&@link_gest;noquote@" class=@func_m;noquote@>Modifica</a>
      </td>
      <td width="25%" nowrap class=@func_d;noquote@>
         <a href="coimdist-gest?funzione=D&@link_gest;noquote@" class=@func_d;noquote@>Cancella</a>
      </td>
   </else>
</tr>
</table>
...
<tr><td valign=top align=right class=form_title>Tipo di energia Trattata</td>
    <td valign=top colspan=3><formwidget id="tipo_energia">
        <formerror  id="tipo_energia"><br>
        <span class="errori">@formerror.tipo_energia;noquote@</span>
        </formerror>
    </td>
</tr>
