...
set page_title      "Stampa distinta allegati L"
...
set nome_file_tot    "Stampa distinta allegati L"
...
# estraggo uten_cognome_nome per specificare nella pagina quali allegati L
# sono stati selezionati
    ...
    set uten_cognome_nome "Amministratore: <b>$uten_cognome $uten_nome</b>"
#} 
	    ...
	    if {$ctr_rec > 0} {
			...
			foreach riga_all $lista_all {
			    ...
			    if {[string equal $mese_rif ""]
					...
					set nome_file       "Stampa distinta allegati L di $nome_mese"
					...
					append righe_stampa "
		                        ...
		                        <!-- FOOTER CENTER \"Distinta allegati L\"-->
					...
					append righe_stampa "
		                        <br>
		                        <h2>Distinta allegati L n. $cod_documento del $sysdate_edit - Mese di $nome_mese</h2>
					...
					append righe_stampa "
		                        <table width=100% border=1>
		                            <tr>
										...
										<th align=left   valign=top>Potenza</th>
		                            </tr>"	
			    }
			    ...
			    append righe_stampa "
	                            <tr>
									...
									<td align=left   valign=top>$potenza</td>
	                           </tr>"
