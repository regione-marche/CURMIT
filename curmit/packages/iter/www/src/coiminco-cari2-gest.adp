...
<b>Ragione sociale dell'utilizzatore;Tipo toponimo;Nome toponimo;Civico;Esponente;Cap;Comune;Codice Istat del Comune;Numero telefonico;Combustibile;Codice utenza/impianto utilizzato dal distributore;Codice impianto utilizzato dagli enti;Consumo annuo;Unit&agrave; di misura del Consumo;Tipo contratto;Volumetria riscaldata;Codice fiscale del cliente-utente;P.Iva del cliente-utente</b>
<p>Ragione sociale dell'utilizzatore, Tipo toponimo, Nome toponimo, Civico, Esponente, Cap, Codice Istat del Comune, Combustibile, Codice utenza/impianto utilizzato dal distributore, Unit&agrave; di misura del Consumo, Tipo contratto sono dati obbligatori.
