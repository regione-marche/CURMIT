...
<!-- Inizio della form colorata -->
   <table border="0" width="96%" align="center">
      <tr>
         <td colspan="6" class="func-menu"><b>Allegato E4 - Scheda identificativa per Impianti a Pompe di Calore</b></td>
      </tr>
   </table>
   ...
   <tr><td colspan=6>&nbsp;</td></tr>
	...
	<tr>
      ...
      <tr>
         ...
         <td colspan="5">
		  ...
		  <td valign="top" width="32" nowrap>(<formwidget id="provincia">)</td>
		  <td valign="top" align="right" class="form_title" width="35">CAP&nbsp;</td>
		  <td valign="top">
		     <formwidget id="cap">@cerca_cap;noquote@
		     <formerror  id="cap">
			<br>
	...
	<tr><td colspan=6>&nbsp;</td></tr>
    <tr><td colspan=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>1.2. IMPIANTO TERMICO DESTINATO A</b></td>
    	<td><formwidget id="cod_utgi">
	   	<formerror id="cod_utgi"><br><span class="errori">@formerror.cod_utgi;noquote@</span></formerror>
        </td>
        <td colspan=4>&nbsp;</td>	 
	</tr>
	<tr><td colspan=6>&nbsp;</td></tr>
    ...
    <tr><td colspan=6>&nbsp;</td></tr>
    <tr><td colspan=2 nowrap> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>1.3. DATA DI INSTALLAZIONE/RISTRUTTURAZIONE</b></td>
		<td><formwidget id="data_installaz">
	...
	<tr><td colspan=6>&nbsp;</td></tr>
    <tr><td colspan=6> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>1.4. POMPA DI CALORE</b></td></tr>
	<tr><td colspan=6>&nbsp;</td></tr>
  
	<tr>	
	<td valign="top" width="10%" align="right" class="form_title" nowrap>Alimentazione</td>
	<td valign="top" width="30%"><formwidget id="alimentazione"> 
    	<formerror id="alimentazione">
    	<br>
	<span class="errori">@formerror.alimentazione;noquote@</span>
		</formerror>
    </td>	 
    <td valign="top" width="30%" align="left" class="form_title">COP
    	<formwidget id="cop"> 
	    <formerror id="cop">
	 	<br>
	...
	<td valign="top" width="30%" align="left" class="form_title">PER
		<formwidget id="per"> 
		<formerror id="per">
	    <br>
	...
	<tr><td valign="top" align="right" class="form_title" nowrap>Fonte di calore</td>
		<td valign="top"><formwidget id="fonte_calore"> 
    	<formerror id="fonte_calore">
	    <br>
		<span class="errori">@formerror.fonte_calore;noquote@</span>
        </formerror>
        </td>
        <td colspan=4>&nbsp;</td>
	</tr>
     ...
     <table border="0" width="100%" border="0" allign="center" cellpadding="0" cellspacing="2">
    <tr><td colspan=6>&nbsp;</td></tr>
    <tr><td colspan=6>&nbsp;</td></tr>
