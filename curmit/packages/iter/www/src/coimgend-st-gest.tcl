...
set link_gest [export_url_vars cod_impianto gen_prog st_progressivo st_data_validita last_gen_prog nome_funz nome_funz_caller url_list_aimp url_aimp extra_par caller]
