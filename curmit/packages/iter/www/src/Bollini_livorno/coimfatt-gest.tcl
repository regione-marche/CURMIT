...
#	    set calc_imp [expr $calc_imp * 100 / 120]
...
#	    } else {
#		element set_properties $form_name mod_pag    -value "30 giorni"
#	    }
...
#	    element set_properties $form_name n_bollini    -value $nr_bollini
	...
	db_foreach query { 
		...
		"1" {
		    ...
		    element set_properties $form_name imp_pagato1   -value $imp_pagato
		}
		"2" { 
		    ...
		    element set_properties $form_name imp_pagato2   -value $imp_pagato
		}
		"3" { 
		    ...
		    element set_properties $form_name imp_pagato3   -value $imp_pagato
 		}
                "4" {
		    ...
		    element set_properties $form_name imp_pagato4   -value $imp_pagato
		}
	    }
...
#########
  ...
  # Lancio la query di manipolazione dati contenute in dml_sql
	...
	db_foreach cerca-boll { 
	    ...
	    append  bollini $cod_bollini    
	}
        with_catch error_msg {
            db_transaction {
                db_dml dml_coimfatt $dml_sql
