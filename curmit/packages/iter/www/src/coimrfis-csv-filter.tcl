...
set titolo       "Scarico File riepilogo R.Fisc"
set button_label "Seleziona" 
set page_title   "Scarico File riepilogo R.Fisc"
...
if {[form is_valid $form_name]} {
    ...
    set link_gest [export_url_vars da_data a_data nome_funz nome_funz_caller]

    set return_url "coimrfis-csv?$link_gest"    
