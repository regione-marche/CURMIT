...
<queryset>
    ...
    <fullquery name="sel_dimp_si_vie">
       <querytext>
		       ...
		       ,a.cod_combustibile
                       ...
                       ,a.cod_proprietario
                       ,coalesce(k.cognome, '')||' '||
                        coalesce(k.nome, '') as nominativo_resp
                       ,k.cognome as cognome_resp
                       ,k.nome as nome_resp
                       ,k.indirizzo as indirizzo_resp
		       ,k.numero    as numero_resp
                       ,k.localita as localita_resp
                       ,k.comune as comune_resp
                       ,k.provincia as provincia_resp
                       ,k.cap as cap_resp
                       ,k.telefono as telefono_resp
		       ,a.cod_occupante
		       ...
		       ,e.numero    as numero_util
                       ...
                       ,b.mod_funz
                       ,b.tipo_bruciatore
                       ,iter_edit_num(b.campo_funzion_min,2) as campo_funzion_min
                       ...
                       ,j.stagione_risc
                       ,j.stagione_risc2
                       ,iter_edit_num(j.consumo_annuo2,2) as consumo_annuo2                 
                       ,j.schemi_funz_idr
                       ,j.schemi_funz_idr_note
                       ,j.schemi_funz_ele
                       ,j.schemi_funz_ele_note
                       ,o.cognome||' '||o.nome as opmanu
                                       from coimdimp j
                  ...
                  left outer join coimopma o on o.cod_opma       = j.cod_opmanu_new
    ...
    <fullquery name="sel_cod_gend">
       <querytext>
              select b.gen_prog as gen_progg 
                from coimdimp b
    ...
    <fullquery name="sel_dimp_n">
       <querytext>
		       ...
		       ,a.cod_combustibile
                  ...
                  left outer join coimutgi n on n.cod_utgi       = b.cod_utgi
                 where j.cod_dimp    <> :cod_dimp
                   and j.cod_impianto   = :cod_impianto
                   and j.data_controllo = :data_controllo_db
                   and j.gen_prog       = :gen_prog_n
       </querytext>
    </fullquery>
