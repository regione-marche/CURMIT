...
if {![string equal $cod_impianto_old ""]} {
    ...
    set impianto_old_adp "
       <tr><td colspan=2 align=center>
           <a href=coimaimp-gest?funzione=V&[export_url_vars nome_funz_caller]&cod_impianto=$cod_impianto_old&nome_funz=impianti ><b>Ultimo impianto inserito di codice: $cod_impianto_est_old</b></a>
         </td>
      </tr>"
} else {
    set impianto_old_adp ""
...
set page_title      "Inserimento nuovo impianto" 
set titolo          "Inserimento nuovo impianto"
...
#} {
    ...
    -widget   text \
    -datatype text \
    -html    "size 10 maxlength 10 $readonly_fld {} class form_element tabindex 1" \
    -optional
#}
 ...
 #   }
  ...
  #  } {
	if {[string equal $cod_impianto_est_new ""]} {
	    #append mex_err_cod_impianto "Inserire il codice Targa"
	} else {
	    if {[string length $cod_impianto_est_new] < 16} {
		append mex_err_cod_impianto "Il codice targa deve essere lungo almeno 16 caratteri" 
	    }
	}
    #}
  ...
  # in questo modo si e' sicuri che f_comune e' stato valorizzato.
    ...
    set link_list [export_url_vars flag_tracciato cod_impianto_est_new f_resp_cogn f_resp_nome f_comune f_cod_via f_desc_via f_desc_topo caller funzione nome_funz_caller nome_funz]

    set return_url "coimaimp-ins-list?$link_list"    
