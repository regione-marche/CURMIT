...
set page_title      "Lista Storico tecnici coinvolti"
...
set link    "\[export_url_vars cod_impianto data_fin_valid last_data_fin_valid curr_data_fin_valid ruolo nome_funz nome_funz_caller extra_par url_list_aimp url_aimp \]"
set actions "
...
set table_def [list \
     ...
     [list des_ruolo               "Ruolo"                 no_sort {c}] \
     [list cognome                 "Cognome"               no_sort {c}] \
     [list nome                    "Nome"                  no_sort {c}] \
]
...
set sel_sogg [db_map sel_sogg_t]
