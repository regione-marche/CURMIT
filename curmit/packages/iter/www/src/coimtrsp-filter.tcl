...
if {[form is_valid $form_name]} {
  ...
  # controlli standard su numeri e date, per Ins ed Upd
    ...
    set link_list [export_url_vars caller nome_funz receiving_element f_cod_cittadino f_cognome f_nome f_cod_fiscale f_comune]

    set return_url "coimtrsp-list?$link_list"
