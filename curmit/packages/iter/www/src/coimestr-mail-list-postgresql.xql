...
<!--
    USER  DATA       MODIFICHE
    ===== ========== =======================================================================
    rom03 15/03/2021 Commentata la condizione su flag_dpr412 = 'S' nelle varie query perche'
    rom03            per le Marche il campo non e' piu' visibile. La modifica va bene per
    rom03            tutti perche' la funzione e' usata solo da Comune e Provincia di Ancona.

    rom02 16/07/2018 Aggiunti cod_manuentore e mnutentore.
...
<queryset>
       ...
       <querytext>
            select * -- nic01
		     ...
		     , c.denominazione as comune
		      ...
		      , a.cod_manutentore as cod_manutentore --rom02 
		      , coalesce(coalesce(ma.cognome,'') ||' '||coalesce(ma.nome, ''),'') as manutentore --rom02		      	  
                   from coimaimp a
		  $from_inco
                  $from_manc
	...
	-- san02  left outer join coimviae d
                 ...
                 ,coimgend vv
		 ,coimmanu ma  --rom02 
                 where --rom03 a.flag_dpr412 = 'S'
		       1 = 1 --rom03
                   and a.cod_manutentore = ma.cod_manutentore --rom02
                $where_dimp
		$where_manu --rom01
                $where_dipe
                $where_anom
     ...
     order by cod_manutentore  --rom02
            , comune           -- nic01
