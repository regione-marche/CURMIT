<!--
    ...
    rom05 29/08/2018 Su richiesta della Regione marche modificata label "Cognome" in 
    rom05            "Cognome o Ragione sociale" nella sezione "Dati relativi ai Soggetti operanti sull'impianto"

    rom04 31/07/2018 Su richiesta della Regione marche modificata dicitura iniziale.

    gac01 29/06/2018 Modificate label

    rom03 27/06/2018 Cambiata l'impaginazione per la Regione Marche.
...
<td class="func-menu-yellow2"><b>In questa scheda vengono richiesti i dati necessari per controllare<br>se l’impianto &egrave; gi&agrave; nel catasto e, nel caso non ci sia, per inserirlo in CURMIT</b></td>
  ...
  <else>
      ...
      <tr>
	    ...
	    <formwidget id="cod_tpim">
         ...
         <td valign="top" align="right"  nowrap class="form_title">Combust.<font color=red>*</font></td><!--rom06 agg. *-->
   ...
   <table border="0" width="96%" align="center" cellpadding="0" cellspacing="2">
      <tr>
	 <td valign="top" align="right" class="form_title"><b>Responsabile</b> <font color=red>*</font></td><!--rom06 aggiunto *-->
	 <td valign="top" colspan="6">
      ...
      <tr>
	 <td>&nbsp;</td>
	 <td valign="bottom" width="14%"><b>Cognome o<br>Ragione sociale</b></td><!--rom05 Cognome-->
	 ...
	 <td valign="bottom"><b>Nome</b></td>
      ...
      <tr>
	 <td valign="top" align="right" class="form_title"><b>Proprietario</b>@asterisco_proprietario;noquote@</td><!--rom06 agg.asterisco_proprietario -->
	 <td valign="top" nowrap colspan="2" width="40%">
	    ...
	    <formerror id="cognome_prop">
         ...
         <td valign="top" align="right" class="form_title" nowrap><b>Intestatario di fornitura energetica</b></td><!--gac01-->
	 ...
	 <td valign="top" nowrap colspan="2">
      ...
      <tr>
	 <td valign="top" align="right" class="form_title" nowrap><b>Terzo responsabile</b></td>
	 <td valign="top" nowrap colspan="2" width="40%">
  ...
  <if @coimtgen.regione@ eq "MARCHE"> <!-- rom03aggiunta if-->
    <tr>
         <td valign="top" align="right" nowrap class="form_title">Data install.<font color=red>*</font></td><!--rom06 agg.*-->
         <td valign="top" nowrap width="8%">
            <formwidget id="data_installaz">
            <formerror id="data_installaz">
               <br>
         ...
         <td valign="top" align="right" class="form_title">Data Costr.<font color=red>*</font></td><!--rom06 agg.*-->
         <td valign="top" width="8%" colspan="3">
            <formwidget id="anno_costruzione">
            <formerror id="anno_costruzione">
               <br>
      ...
      <tr>
	 <td valign="top" align="right" nowrap class="form_title">Costruttore<font color=red>*</font></td><!--rom06 agg. *-->
	 <td valign="top">
	 ...
	 <td valign="top" align="right" nowrap class="form_title">Modello<font color=red>*</font></td><!--rom06 agg. *-->
         ...
         <td valign="top" align="right" nowrap class="form_title">Matricola<font color=red>*</font></td><!--rom06 agg. *-->
	 <td valign="top">
      ...
      <tr>
  <if @coimtgen.regione@ ne "MARCHE"> <!-- rom03aggiunta if-->
  ...
  <if @coimtgen.regione@ ne "MARCHE"> <!-- rom03aggiunta if-->
    ...
    <td valign=top nowrap><formwidget id="pod">
      ...
      <tr>
        <td width="18%" valign="top" align="right" nowrap class="form_title">Pot. foc. nom.(kW)<font color=red>*</font></td><!--rom06agg.*-->
...
<!-- gac01	 <td width="10%" valign="top" align="right" nowrap class="form_title">Fascia</td>
	 <td width="25%" valign="top"><formwidget id="cod_potenza">
       ...
       <td width="20%" valign="top" align="right" nowrap class="form_title">Pot. utile nom.(kW)<font color=red>*</font></td><!--rom06agg.*-->
