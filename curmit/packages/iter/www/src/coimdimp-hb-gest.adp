...
<tr>
   <td width="14.29%" nowrap class=@func_i;noquote@>
       <a href="coimdimp-gest?funzione=I&flag_tracciato=HB&@link_gest;noquote@" class=@func_i;noquote@>Nuovo Mod. H bis</a>
   </td>
   <if @funzione@ ne I>
...
<tr><td><table><tr>
    ...
    <td valign=top align=right class=form_title>Data arrivo all'ente</td>
...
<tr><td><table width="100%">
    <tr>
        <td width="20%" valign=top align=left class=form_title>Manutentore <font color=red>*</font></td>
        <td width="20%" valign=top align=left class=form_title>Responsabile</td>
        <td width="20%" valign=top align=left class=form_title>Proprietario</td>
        <td width="20%" valign=top align=left class=form_title>Occupante</td>
        <td width="20%" valign=top align=left class=form_title>Intestatario Contratto</td>
    </tr>
    <tr>
