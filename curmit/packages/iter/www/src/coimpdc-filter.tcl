...
switch $nome_funz {
    "tele"  {set page_title "Inserimento allegato E4 - Bonifica impianti"
	set titolo          "Inserimento allegato E4 - Ricerca Impianti"     
    }
    default {set page_title "Inserimento allegato E4 - Bonifica impianti"
	set titolo          "Inserimento allegato E4 - Bonifica impianti"
    }
}
...
if {[form is_valid $form_name]} {
  ...
  # in questo modo si e' sicuri che f_comune e' stato valorizzato.
    ...
    set return_url "coimpdc-list?$link_list"    
