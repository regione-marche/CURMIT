ad_page_contract {
    Scarico tabella "coimrelg" Scheda generale relazione biennale
    ...
    @param cod_relg          chiave della tabella,
                             identifica il record da scaricare
    @cvs-id coimrelg-scar.tcl 
} { 
   {nome_funz ""}
   {cod_relg  ""}
}  -properties {
...
lappend file_cols resp_proc
lappend file_cols nimp_tot_stim_ente
lappend file_cols nimp_tot_aut_ente
lappend file_cols nimp_tot_centr_ente
lappend file_cols nimp_tot_telerisc_ente
lappend file_cols conv_ass_categ
lappend file_cols conf_dgr7_7568
lappend file_cols npiva_ader_conv
lappend file_cols npiva_ass_acc_reg
lappend file_cols delib_autodic
lappend file_cols rifer_datai
lappend file_cols rifer_dataf
lappend file_cols valid_datai
lappend file_cols valid_dataf
lappend file_cols ntot_autodic_perv
lappend file_cols ntot_prescrizioni
lappend file_cols n_ver_interni
lappend file_cols n_ver_esterni
lappend file_cols n_accert_enea
lappend file_cols n_accert_altri
