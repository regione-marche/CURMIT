    ...
    <fullquery name="sel_gend">
       <querytext>
		  ...
		  , gen_prog_est
              ...
              where cod_impianto = :cod_impianto
                and gen_prog     = :gen_prog
                and st_data_validita = :st_data_validita
                and st_progressivo = (select max(st_progressivo) from coimgend_st where cod_impianto = :cod_impianto and gen_prog     = :gen_prog and st_data_validita = :st_data_validita)
       </querytext>
    </fullquery>
