...
switch $nome_funz_caller {
    tele {
	set page_title      "Inserimento allegato E3 - Bonifica impianti"
    }
    default {
...
set link_aggiungi "<a href=\"coimtele-ins-gest?funzione=I&$link_isrt&nome_funz=tele\">Aggiungi nuovo impianto"
...
if {[form is_valid $form_name]} {
    ...
    set return_url   "coimtele-gest?[export_url_vars flag_tracciato destinazione compatta_list nome_funz nome_funz_caller f_comune cod_impianto_est_new f_resp_cogn f_resp_nome f_cod_via f_desc_via f_desc_topo search_word]"
