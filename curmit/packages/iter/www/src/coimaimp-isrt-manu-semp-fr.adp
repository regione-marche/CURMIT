...
<td class="func-menu-yellow2"><b>In questa scheda vengono richiesti i dati necessari per controllare<br>se l’impianto &egrave; gi&agrave; nel catasto e, nel caso non ci sia, per inserirlo in CURMIT</b></td>
   ...
   <table width="100%" border="0" allign="center" cellpadding="0" cellspacing="2">
      <tr>
         ...
         <td valign="top" width="25%" align="right" nowrap class="form_title">Stato</td>
	 ...
	 <td></td>
      ...
      <tr>
	    ...
	    <formwidget id="cod_tpim">
         ...
         <td valign="top" align="right"  nowrap class="form_title">Combust.<font color=red>*</font></td>
      ...
      <tr>
	   ...
	   <table width=100% border="0" cellpadding="0" cellaspacing="0">
              <tr>
   ...
   <table border="0" width="96%" align="center">
      <tr>
         <td width="100%" class="func-menu-yellow2"><b>Dati Relativi al Gruppo Frigo/Pompa di calore</b> (con potenza nominale più elevata), Attenzione ad eventuali warning che appariranno</td>
      </tr>
   </table>
...
-->
	 ...
	 <td valign="top" align="right" nowrap class="form_title">Fascia</td>
	...
	<tr>
          <td valign="top" align="right" nowrap class="form_title">Poteza frigorifera nominale(kW)<font color=red>*</font></td>
	  <td valign="top">
	...
	<tr>
	 ...
	 <td valign="top" colspan="3">
      ...
      <tr>
         <td valign="top" align="right" class="form_title">Carica refrig. (Kg)</td>
	 <td valign="top" colspan="1">
