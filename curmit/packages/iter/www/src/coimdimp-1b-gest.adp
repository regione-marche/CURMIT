...
<tr>
   ...
   <td width="12.5%" nowrap class=@func_i;noquote@>
       <a href="coimdimp-gest?funzione=I&flag_tracciato=@flag_tracciato;noquote@&@link_gest;noquote@" class=@func_i;noquote@>Nuovo Allegato</a>
   </td>
   </else>
   <if @funzione@ ne I and @menu@ eq 1>
       ...
       <td width="12.5%" nowrap class=func-menu>
           <a href="@pack_dir;noquote@/coimdimp-1b-layout?@link_gest;noquote@&flag_ins=N" class=func-menu target="Stampa ">Stampa RCEE (Tipo 1)</a>
       </td>
       <td width="12.5%" nowrap class=func-menu>
           <a href="@pack_dir;noquote@/coimdimp-1b-layout?@link_gest;noquote@&flag_ins=S" class=func-menu target="Stampa RCEE (Tipo 1)">Ins. Doc.</a>
       </td>
   </if>
   <else>
...
<tr><td><table border=0 width="100%">
    <tr>
        ...
        <td width="17%" valign=top align=left class=form_title>Op. manutentore<if @coimtgen.ente@ ne "PLI"
...
<tr><td><table border=0 width=100%><tr>
    <td width=50% valign=top><table border=0 width=100% border=1><tr>
    ...
    <td valign=top align=right class=form_title>Istruzioni uso e manutenzione dell'impianto presenti</td>
    <td valign=top><formwidget id="libretto_manutenz">
    ...
    <td valign=top align=right class=form_title>SCIA o CPI antincendio</td>
    <td valign=top><formwidget id="doc_prev_incendi">
    ...
    <td valign=top align=right class=form_title>Documentazione art. 284 del Dlgs 152/06 presente</td>
    <td valign=top><formwidget id="dich_152_presente">
    ...
    <td valign=top align=right class=form_title>Pratica INAIL (ex ISPESL)</td>
    <td valign=top><formwidget id="doc_ispesl">
    ...
    <td valign=top><formwidget id="ap_vent_ostruz">
        ...
        <td valign=top align=right class=form_title>Pulizia camino effettuata secondo UNI 10847</td>
    <td valign=top><formwidget id="lg_flag_puliz_camino">
        <formerror  id="lg_flag_puliz_camino"><br>
        <span class="errori">@formerror.lg_flag_puliz_camino;noquote@</span>
        </formerror>
    </td>
    </tr><tr>
    ...
    <td valign=top align=right class=form_title>Presente separazione idraulica tra generatori (ove richiesta)</td>
    <td valign=top><formwidget id="lg_flag_sep_gen">
        <formerror  id="lg_flag_sep_gen"><br>
        <span class="errori">@formerror.lg_flag_sep_gen;noquote@</span>
        </formerror>
    </td>
    </tr><tr>
    <td valign=top align=right class=form_title>Idoneit&agrave stoccaggio/deposito combistibile solido</td>
    <td valign=top><formwidget id="lg_flag_dep_combust_solido">
        <formerror  id="lg_flag_dep_combust_solido"><br>
        <span class="errori">@formerror.lg_flag_dep_combust_solido;noquote@</span>
        </formerror>
    </td>
    <td valign=top align=right class=form_title>Organi soggetti a sollecitazione termiche integri</td>
    <td valign=top><formwidget id="lg_flag_sollecit_termiche">
        <formerror  id="lg_flag_sollecit_termiche"><br>
        <span class="errori">@formerror.lg_flag_sollecit_termiche;noquote@</span>
        </formerror>
    </td>
    </tr></table></td></tr>
...
<tr>
    ...
    <td valign=top colspan=5><formwidget id="rct_gruppo_termico">
...
<tr>
    ...
    <td colspan=5 valign=top><formwidget id="id_tplg">
        <formerror  id="id_tplg"><br>
        <span class="errori">@formerror.id_tplg;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title>Note altro</td>
    <td colspan=5 valign=top><formwidget id="note_tplg_altro">
        <formerror  id="note_tplg_altro"><br>
        <span class="errori">@formerror.note_tplg_altro;noquote@</span>
        </formerror>
    </td>
...
<tr>
    <td valign=top align=right class=form_title colspan=2>Condensazione:</td>
    <td valign=top><formwidget id="lg_condensazione">
        <formerror  id="lg_condensazione"><br>
        <span class="errori">@formerror.lg_condensazione;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title colspan=2>Vaso di espansione:</td>
    <td valign=top><formwidget id="lg_vaso_espa">
        <formerror  id="lg_vaso_espa"><br>
        <span class="errori">@formerror.lg_vaso_espa;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title colspan=2>Marcatura CE apparecchio:</td>
    <td valign=top><formwidget id="lg_marcatura_ce">
        <formerror  id="lg_marcatura_ce"><br>
        <span class="errori">@formerror.lg_marcatura_ce;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title colspan=2>Placca camino:</td>
    <td valign=top><formwidget id="lg_placca_cam">
        <formerror  id="lg_placca_cam"><br>
        <span class="errori">@formerror.lg_placca_cam;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title colspan=2>Caricamento combustibile:</td>
    <td valign=top><formwidget id="lg_caric_comb">
        <formerror  id="lg_caric_comb"><br>
        <span class="errori">@formerror.lg_caric_comb;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title colspan=2>Modalità evacuazione fumi:</td>
    <td valign=top><formwidget id="lg_mod_evac_fumi">
        <formerror  id="lg_mod_evac_fumi"><br>
        <span class="errori">@formerror.lg_mod_evac_fumi;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
    <td valign=top align=right class=form_title colspan=2>Aria comburente</td>
    <td valign=top><formwidget id="lg_aria_comburente">
        <formerror  id="lg_aria_comburente"><br>
        <span class="errori">@formerror.lg_aria_comburente;noquote@</span>
        </formerror>
    </td>
</tr>
<tr>
 <td valign=top align=right class=form_title colspan=2>Depressione canale da Fumo (Pa)</td>
    <td valign=top><formwidget id="tiraggio_fumi">
...
<tr>
    <td><table border=0><tr>
           <td valign=bottom align=left class=form_title><b>G.OSSERVAZIONI</b></td>
         </tr>
         <tr>
         ...
         <tr>
             <td valign=bottom align=left class=form_title><b>H.RACCOMANDAZIONI</b><br> (in attesa di questi interventi l'impianto pu&ograve; essere messo in funzione)</td>
         </tr>
         <tr>
         ...
         <tr>
            <td valign=top align=left class=form_title><b>I.PRESCRIZIONI</b><br> (in attesa di questi interventi l'impianto <b>non</b> pu&ograve; essere messo in funzione)</td>
         </tr>
         <tr>
