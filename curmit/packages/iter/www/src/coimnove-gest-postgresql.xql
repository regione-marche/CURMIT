...
<queryset>
    ...
    <fullquery name="sel_nove">
       <querytext>
                select a.cod_manutentore
                     ...
                     , flag_installatore
                     , flag_manutentore
                     , iter_edit_num(pot_termica_mw, 4) as pot_termica_mw
                     , combustibili
                     , n_focolari
                     , pot_focolari_mw
                     , n_bruciatori
                     ...
                     , flag_consegnato
                     , firma
                     , iter_edit_data(a.data_rilascio) as data_rilascio
               from coimnove a
              where cod_nove = :cod_nove
       </querytext>
    </fullquery>
    ...
    <fullquery name="sel_next_nove">
       <querytext>
        select coalesce(max(to_number(cod_nove, '99999990') ),0) + 1 as cod_nove from coimnove
       </querytext>
    </fullquery>
