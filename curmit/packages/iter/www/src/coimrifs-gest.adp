...
<tr>
   <td width="25%" nowrap class=func-menu>
       <a href="coimrifs-list?@link_list;noquote@" class=func-menu>Ritorna</a>
   </td>
...
<tr>
    <td valign=top align=right class=form_title>Cod. Fiscale</td>
    <td valign=top><formwidget id="cf"></td>
</tr>
