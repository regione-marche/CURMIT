...
set link_gest [export_url_vars cod_distr last_cod_distr nome_funz extra_par]
...
#                     [list coimdist-list?$link_list "Lista Distributori"] \
#                     "$page_title"]
#}
...
element create $form_name tipo_energia\
-label   "Tipo Energia Trattata" \
-widget   select \
-datatype text \
-html    "$disabled_fld {} class form_element" \
-optional \
-options {{{}} {"Elettrica" E} {"Termica" T} {"Elettrica/Termica" G}}
...
if {[form is_request $form_name]} {
    ...
    if {$funzione == "I"} {
      ...
      # leggo riga
        ...
        element set_properties $form_name tipo_energia -value $tipo_energia
...
if {[form is_valid $form_name]} {
  # form valido dal punto di vista del templating system
    ...
    set tipo_energia [string trim [element::get_value $form_name tipo_energia]]
  ...
  # controlli standard su numeri e date, per Ins ed Upd
    ...
    if {$funzione == "D"
      && $conta_aimp > 0} {
	element::set_error $form_name cod_distr "Il fornitore &egrave; collegato a degli impianti"
	incr error_num
    }
  ...
  # dopo l'inserimento posiziono la lista sul record inserito
    ...
    switch $funzione {
        M {set return_url   "coimdist-gest?funzione=V&$link_gest"}
        D {set return_url   "coimdist-list?$link_list"}
        I {set return_url   "coimdist-gest?funzione=V&$link_gest"}
