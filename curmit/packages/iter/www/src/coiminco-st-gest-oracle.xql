    ...
    <fullquery name="sel_inco">
       <querytext>
             select a.cod_inco
                  ...
                  , iter_edit.time(a.ora_verifica)    as ora_verifica
                  , iter_edit.data(a.data_avviso_01)  as data_avviso_01
                  , a.cod_documento_01
                  , iter_edit.data(a.data_avviso_02)  as data_avviso_02
                  , a.cod_documento_02
                  , a.stato
                  , a.esito
       ...
       <querytext>
        select ora_da 
         ...
         where ora_da  <= :ora_verifica_old
           ...
           and cod_opve = :cod_opve_old
       </querytext>
    </fullquery>

    <fullquery name="sel_cod_inco_dual">
       <querytext>
           select coiminco_s.nextval as cod_inco_crea
             from dual
       </querytext>
    </fullquery>
