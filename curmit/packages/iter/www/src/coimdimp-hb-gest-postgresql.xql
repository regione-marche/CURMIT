...
<queryset>
    ...
    <fullquery name="sel_dimp">
       <querytext>
             select a.cod_dimp
                  ...
                  , a.tipologia_costo
                  , riferimento_pag
                  , iter_edit_data(f.data_scad) as data_scad
		  , case
		  ...
		  , iter_edit_data(a.data_arrivo_ente) as data_arrivo_ente
	       ...
	       left outer join coimcitt d on d.cod_cittadino    = a.cod_proprietario
               ...
               left outer join coimmovi f on f.riferimento      = a.cod_dimp
    ...
    <partialquery name="upd_aimp_ultim_dich">
       <querytext>
        update coimaimp
           set data_ultim_dich = :data_ultim_dich
    ...
    <fullquery name="sel_gend">
       <querytext>
		...
		, iter_edit_data(e.data_installaz) as data_insta
		, a.tiraggio
