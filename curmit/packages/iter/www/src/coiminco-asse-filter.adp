...
<%=[iter_form_iniz]%>
<tr><td valign=top align=center colspan=4><b>Criteri</b></td></tr>
<!-- dpr74 -->
...
<tr>
    <td valign=top align=right class=form_title>Numero estrazioni</td>
    <td valign=top colspan=3><formwidget id="f_num_asse">
        <formerror  id="f_num_asse"><br>
        <span class="errori">@formerror.f_num_asse;noquote@</span>
        </formerror>
</tr>

<tr><td>&nbsp</td></tr>
<tr><td valign=top align=center colspan=4><b>Parametri</b></td></tr>
...
<if @flag_asse_data@ eq S>
    <tr>
        <td valign=top align=right class=form_title>Data inizio assegnazione</td>
        <td valign=top colspan=3><formwidget id="f_da_data_disp">
                                 <formerror  id="f_da_data_disp"><br>
                                 <span class="errori">@formerror.f_da_data_disp;noquote@</span>
                                 </formerror>
    </tr>
</if>
