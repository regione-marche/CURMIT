...
<if @funzione@ ne "V">
    <tr><td colspan=2 align=center><!-- strong>Attenzione: Comando di Lancio Temporaneamente Disabilitato.</strong--><formwidget id="submit"></td></tr>
</if>
<else>
...
<tr><td valign=top class=form_title>
    Da questa pagina &egrave; possibile caricare nuovi modelli utilizzando un file csv.
<br><br>Le righe devono seguire le indicazioni fornite con il tracciato excel di riferimento per il caricamento in questione.
<br>La prima riga di questo file non viene caricata perch&egrave; si prevede che contenga le intestazioni delle colonne come da tracciato.
...
<tr>
    <td align=center> @link_saldo;noquote@ <b>@saldo;noquote@ @conto_manu;noquote@</b> </td>   
</tr>
</if>
