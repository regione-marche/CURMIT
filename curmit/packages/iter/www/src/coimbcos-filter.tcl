...
set titolo       "Bonifica costruttori"
...
if {[form is_valid $form_name]} {
    ...
    set link_list [export_url_vars caller nome_funz nome_funz_caller receiving_element f_costruttore]
    set return_url "coimbcos-list?$link_list"
