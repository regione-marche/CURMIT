ad_page_contract {
    Bonfica allegati E4 (pompe di calore - vecchia normativa)
    ...
    #sugli Allegati E4.
    #Il programma non viene più utilizzato: da menu' viene chiamato coimpdc-ins-gest.
} { 
    {caller          "index"}
    {nome_funz            ""}
    {nome_funz_caller     ""}
...
set form_valid {
    ...
    set return_url   "coimpdc-ins-gest?funzione=M&[export_url_vars flag_tracciato cod_as_resp nome_funz_caller search_word cod_impianto_est_new]&nome_funz=[iter_get_nomefunz coimpdc-ins-gest]&flag_no_link=T&cod_impianto=$cod_impianto_new"
