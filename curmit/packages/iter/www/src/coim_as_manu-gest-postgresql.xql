       ...
       <querytext>
                update coim_as_resp
                  set  cod_legale_rapp = :cod_legale_rapp
                     ...
                     , fornitore_energia_p = :fornitore_energia_p
		     , flag_as_resp     = :flag_as_resp --rom01
    ...
    <fullquery name="sel_as_resp">
       <querytext>
             select  a.cod_legale_rapp
                     ...
                     , c.cod_distributore as fornitore_energia
                     , a.fornitore_energia_p
		     , a.flag_as_resp --rom01
               from coim_as_resp a
