...
<tr><td colspan=2>&nbsp;</td></tr>
<tr><td valign=top align=right class=form_title>Amministratore</td>
    <td valign=top><formwidget id="cognome_ammi">
...
<tr><td valign=top align=right class=form_title>&nbsp;</td>
    <td valign=top><formwidget id="nome_ammi">@cerca_ammi;noquote@
        <formerror  id="nome_ammi"><br>
        <span class="errori">@formerror.nome_ammi;noquote@</span>
        </formerror>
    </td>   
</tr>
