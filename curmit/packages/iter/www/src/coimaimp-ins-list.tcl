...
set link_filter [export_url_vars caller nome_funz receiving_element cod_impianto_est_new f_resp_cogn f_resp_nome f_comune f_cod_via f_desc_via f_desc_topo flag_tracciato]
...
set link_aggiungi   "<a href=\"coimaimp-isrt-veloce?funzione=I&$link_isrt&nome_funz=$nome_funz\">Aggiungi nuovo impianto"
...
multirow create impianti link cod_impianto resp comune indir stato destinaz
...
db_foreach cmp $sql_query {
    ...
    set link "<a href=coimaimp-sche?nome_funz=impianti&cod_impianto=$cod_impianto&flag_no_links=T target=dett_$cod_impianto >Dettaglio</a>"
    multirow append impianti $link $cod_impianto $resp $comune $indir $stato $destinaz
...
if {[form is_valid $form_name]} {
    ...
    set return_url   "coimaimp-ins-gest?[export_url_vars flag_tracciato destinazione compatta_list nome_funz nome_funz_caller f_comune cod_impianto_est_new f_resp_cogn f_resp_nome f_cod_via f_desc_via f_desc_topo search_word]"    
