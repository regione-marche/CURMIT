    ...
    <partialquery name="ins_dimp">
       <querytext>
		     ...
		     , data_arrivo_ente
                     ...
                     , data_prox_manut
                     , lg_flag_dep_combust_solido
                     , lg_flag_puliz_camino
                     , lg_flag_sep_gen
                     , lg_flag_sollecit_termiche
                     , id_tplg
                     , note_tplg_altro
                     , lg_condensazione
                     , lg_vaso_espa
    ...
    <partialquery name="upd_dimp">
       <querytext>
		     ...
		     , data_arrivo_ente   = :data_arrivo_ente
                     ...
                     , lg_flag_dep_combust_solido = :lg_flag_dep_combust_solido
                     , lg_flag_puliz_camino       = :lg_flag_puliz_camino
                     , lg_flag_sep_gen            = :lg_flag_sep_gen
                     , lg_flag_sollecit_termiche  = :lg_flag_sollecit_termiche
                     , id_tplg                    = :id_tplg
                     , note_tplg_altro            = :note_tplg_altro
                     , lg_condensazione           = :lg_condensazione
                     , lg_vaso_espa               = :lg_vaso_espa
                     , lg_marcatura_ce            = :lg_marcatura_ce
                     , lg_placca_cam              = :lg_placca_cam
                     , lg_caric_comb              = :lg_caric_comb
                     , lg_mod_evac_fumi           = :lg_mod_evac_fumi
                     , lg_aria_comburente         = :lg_aria_comburente
    ...
    <fullquery name="sel_dimp">
       <querytext>
		  ...
		  , iter_edit_data(a.data_arrivo_ente) as data_arrivo_ente
                  ...
                  , g.cod_potenza --sim08
                  , a.lg_flag_dep_combust_solido
                  , a.lg_flag_puliz_camino
                  , a.lg_flag_sep_gen
                  , a.lg_flag_sollecit_termiche
                  , a.id_tplg
                  , a.note_tplg_altro
                  , a.lg_condensazione
                  , a.lg_vaso_espa
