 ...
 $ordinamento
    ...
    <partialquery name="upd_aimp">
       <querytext>
          update coimaimp
	     set stato = 'L'
               , note  = 'Impianto annullato in coseguenza a bonifica'
    ...
    <fullquery name="sel_dual_cod_inco">
        <querytext>
	 select coiminco_s.nextval as cod_inco_new
           from dual
        </querytext>
    </fullquery>
    ...
    <fullquery name="sel_inco_check">
        <querytext>
           select cod_inco as cod_inco_annulla
             from coiminco
            where cod_impianto = :destinazione
    ...
    <partialquery name="upd_inco2">
       <querytext>
	     ...
	     set stato = '5'
               , note  = 'Incontro annullato in conseguenza a bonifica'
           where cod_inco = :cod_inco_annulla
       </querytext>
    </partialquery>
