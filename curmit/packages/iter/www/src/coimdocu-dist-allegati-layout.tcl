ad_page_contract {
    ...
    USER  DATA       MODIFICHE
    ===== ========== =========================================================================
    sim01 28/04/2020 gestito il salvataggio dell'allegato sul file system
...
set page_title      "Stampa distinta allegati H, I"
...
set nome_file_tot    "Stampa distinta allegati HI"
...
if {[string equal $cod_manutentore ""]} {
    ...
    set utente_chk			$id_utente
    set where_utente  "and a.utente = :utente_chk"
} else {
	...
	append utente_chk	"%"
    set where_utente  	"and a.utente like :utente_chk"
}
#ns_return 200 text/html $where_utente;return
iter_get_coimdesc
...
with_catch error_msg {
    db_transaction {
		...
		set note "nota:
					...
					essere inviata all’Ente competente. "
	    ...
	    if {$ctr_rec > 0} {
			...
			foreach riga_all $lista_all {
			    ...
			    if {[string equal $mese_rif ""]
					...
					set nome_file       "Stampa distinta allegati HI di $nome_mese"
					set nome_file_originale  "$nome_file.pdf";#sim01
					...
					append righe_stampa "
		                        ...
		                        <!-- FOOTER CENTER \"Distinta allegati H,I\"-->
					...
					append righe_stampa "
		                        <br>
		                        <h2>Distinta allegati H,I n. $cod_documento del $sysdate_edit - Mese di $nome_mese</h2>
