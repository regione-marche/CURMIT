...
iter_get_coimtgen
# Identifico il settore e il ruolo dell'utente corrente
db_1row select_profilo_utente "" 

set page_title      "Lista Settori"

set context_bar [iter_context_bar -nome_funz $nome_funz_caller]

# imposto le variabili da usare nel frammento html di testata della lista.
set curr_prog       [file tail [ns_conn url]]
set gest_prog       "coimsett-gest"
...
set link    "\[export_url_vars id_settore last_descrizione nome_funz nome_funz_caller extra_par\]"
set actions "
...
set table_def [list \
    	...
    	[list id_settore   "Id settore"   no_sort {l}] \
	[list descrizione  "Descrizione"  no_sort {l}] \
]

# Se non ci si trova sull'ente regione il settore della regione non viene estratto
set flag_regione ""
if {($coimtgen(flag_ente) ne "R") && ($id_settore ne "system")} {
    set flag_regione " and descrizione != 'regione' and descrizione != 'system'"
}
if {($coimtgen(flag_ente) eq "R") && ($id_settore ne "system")} {
    set flag_regione " and descrizione != 'system'"
}
...
set sel_sett [db_map sel_sett]

set table_result [ad_table -Tmax_rows $rows_per_page -Tmissing_text "Nessun dato corrisponde ai criteri impostati." -Textra_vars {descrizione id_settore last_descrizione nome_funz nome_funz_caller extra_par} go $sel_sett $table_def]
