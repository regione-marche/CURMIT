...
set page_title      "Lista Profili"

set context_bar [iter_context_bar -nome_funz $nome_funz_caller]

# imposto le variabili da usare nel frammento html di testata della lista.
set curr_prog       [file tail [ns_conn url]]
set gest_prog       "coimprof-gest"
set form_di_ricerca [iter_search_form $curr_prog $search_word]
set col_di_ricerca  "Profilo"
...
set table_def [list \
    	...
    	[list nome_menu "Profilo"    no_sort {l}] \
	[list settore   "Settore"    no_sort {l}] \
...
if {[string equal $search_word ""]} {
    ...
    set where_word  " and upper(nome_menu) like upper(:search_word_1)"
}

# Se non ci si trova nell'ente regione i profili della regione non vengono estratti
set flag_regione ""
if {($coimtgen(flag_ente) ne "R") && ($id_settore ne "system")} {
    set flag_regione " and settore != 'regione' and settore != 'system'"
}
if {($coimtgen(flag_ente) eq "R") && ($id_settore ne "system")} {
    set flag_regione " and settore != 'system'"
}

# imposto la condizione per la prossima pagina
if {![string is space $last_nome_menu]} {
    set where_last " and nome_menu >= :last_nome_menu"
} else {
    set where_last ""
}

set sel_prof [db_map sel_prof]

set table_result [ad_table -Tmax_rows $rows_per_page -Tmissing_text "Nessun dato corrisponde ai criteri impostati." -Textra_vars {nome_menu last_nome_menu nome_funz nome_funz_caller extra_par} go $sel_prof $table_def]
