...
set gest_prog       "coimuten-gest"
set form_di_ricerca [iter_search_form $curr_prog $search_word]
set col_di_ricerca  "Cognome"
set extra_par       [list rows_per_page     $rows_per_page \
                          receiving_element $receiving_element]
set link_aggiungi   "<a href=\"$gest_prog?funzione=I&[export_url_vars last_utente caller nome_funz extra_par nome_funz_caller]\">Aggiungi</a>"
...
set table_def [list \
	...
	[list livello_edit "Livello"  no_sort {r}] \
        [list cod_utente   "Id utente"  no_sort {r}] \
]
