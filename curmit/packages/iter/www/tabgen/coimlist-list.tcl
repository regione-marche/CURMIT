...
set page_title      "Elenco Listini"

set context_bar [iter_context_bar -nome_funz $nome_funz_caller]

# imposto le variabili da usare nel frammento html di testata della lista.
set curr_prog       [file tail [ns_conn url]]
set gest_prog       "coimlist-gest"
set form_di_ricerca ""
set col_di_ricerca  ""
set extra_par       [list rows_per_page     $rows_per_page \
                          receiving_element $receiving_element]
set link_aggiungi   "<a href=\"$gest_prog?funzione=I&[export_url_vars tipo_costo cod_potenza last_tari caller nome_funz extra_par nome_funz_caller]\">Aggiungi</a>"
set rows_per_page   [iter_set_rows_per_page $rows_per_page $id_utente]
set link_righe      [iter_rows_per_page     $rows_per_page]

set link    "\[export_url_vars cod_listino descrizione last_tari nome_funz nome_funz_caller extra_par\]"
set actions "
...
set table_def [list \
    	...
    	[list cod_listino      "Cod. Listino"    no_sort {l}] \
	[list descrizione      "Descrizone"      no_sort {l}] \
]
...
set table_result [ad_table -Tmax_rows $rows_per_page -Tmissing_text "Nessun dato corrisponde ai criteri impostati." -Textra_vars {cod_listino descrizione last_tari nome_funz nome_funz_caller extra_par} go $sel_tari $table_def]
