...
<tr>
   <td width="25%" nowrap class=func-menu>
       <a href="coim_d_tano-list?@link_list;noquote@" class=func-menu>Ritorna</a>
   </td>
   <if @funzione@ eq "I">
   ...
   <else>
      <td width="25%" nowrap class=@func_v;noquote@>
         <a href="coim_d_tano-gest?funzione=V&@link_gest;noquote@" class=@func_v;noquote@>Visualizza</a>
      </td>
      <td width="25%" nowrap class=@func_m;noquote@>
         <a href="coim_d_tano-gest?funzione=M&@link_gest;noquote@" class=@func_m;noquote@>Modifica</a>
      </td>
      <td width="25%" nowrap class=@func_d;noquote@>
         <a href="coim_d_tano-gest?funzione=D&@link_gest;noquote@" class=@func_d;noquote@>Cancella</a>
      </td>
   </else>
</tr>
</table>
...
<if @flag_enti_compet@ eq T>
    ...
    <tr><td valign=top align=right class=form_title>Classe</td>
        <td valign=top><formwidget id="clas_funz">
            <formerror  id="clas_funz"><br>
