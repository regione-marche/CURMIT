...
<tr>
   <td width="25%" nowrap class=func-menu>
       <a href=coimcurb-list?@link_list;noquote@ class=func-menu>Ritorna</a>
   </td>
   <if @funzione@ eq "I">
   ...
   <else>
      <td width="25%" nowrap class=@func_v;noquote@>
         <a href="coimcurb-gest?funzione=V&@link_gest;noquote@" class=@func_v;noquote@>Visualizza</a>
      </td>
      <td width="25%" nowrap class=@func_m;noquote@>
         <a href="coimcurb-gest?funzione=M&@link_gest;noquote@" class=@func_m;noquote@>Modifica</a>
      </td>
      <td width="25%" nowrap class=@func_d;noquote@>
         <a href="coimcurb-gest?funzione=D&@link_gest;noquote@" class=@func_d;noquote@>Cancella</a>
      </td>
   </else>
</tr>
</table>
...
<tr><td valign=top align=right class=form_title>Codice</td>
    <td valign=top nowrap><formwidget id="cod_urb">
        <formerror  id="cod_urb"><br>
        <span class="errori">@formerror.cod_urb;noquote@</span>
        </formerror>
    </td>
</tr>
<if @funzione@ ne I or @flag_ente@ eq C>
