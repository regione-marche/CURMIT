...
<tr>
   <td width="25%" nowrap class=func-menu>
       <a href=coimtpbl-list?@link_list;noquote@ class=func-menu>Ritorna</a>
   </td>
   <if @funzione@ eq "I">
   ...
   <else>
      <td width="25%" nowrap class=@func_v;noquote@>
         <a href="coimtpbl-gest?funzione=V&@link_gest;noquote@" class=@func_v;noquote@>Visualizza</a>
      </td>
      <td width="25%" nowrap class=@func_m;noquote@>
         <a href="coimtpbl-gest?funzione=M&@link_gest;noquote@" class=@func_m;noquote@>Modifica</a>
      </td>
      <td width="25%" nowrap class=@func_d;noquote@>
         <a href="coimtpbl-gest?funzione=D&@link_gest;noquote@" class=@func_d;noquote@>Cancella</a>
      </td>
   </else>
</tr>
</table>
...
<formwidget   id="last_cod_tipo_bol">
...
<tr><td valign=top align=right class=form_title>Codice</td>
    <td valign=top nowrap><formwidget id="cod_tipo_bol">
        <formerror  id="cod_tipo_bol"><br>
        <span class="errori">@formerror.cod_tipo_bol;noquote@</span>
        </formerror>
    </td>
</tr>
...
<tr><td valign=top align=right class=form_title>Data fine validit&agrave;</td>
    <td valign=top nowrap><formwidget id="data_fine_valid">
