...
<tr>
   <td width="25%" nowrap class=func-menu>
       <a href="coimtppt-list?@link_list;noquote@" class=func-menu>Ritorna</a>
   </td>
   <if @funzione@ eq "I">
   ...
   <else>
      <td width="25%" nowrap class=@func_v;noquote@>
         <a href="coimtppt-gest?funzione=V&@link_gest;noquote@" class=@func_v;noquote@>Visualizza</a>
      </td>
      <td width="25%" nowrap class=@func_m;noquote@>
         <a href="coimtppt-gest?funzione=M&@link_gest;noquote@" class=@func_m;noquote@>Modifica</a>
      </td>
      <td width="25%" nowrap class=@func_d;noquote@>
         <a href="coimtppt-gest?funzione=D&@link_gest;noquote@" class=@func_d;noquote@>Cancella</a>
      </td>
   </else>
</tr>
</table>
...
<tr><td valign=top align=right class=form_title>Codice</td>
    <td valign=top><formwidget id="cod_tppt">
    <formerror  id="cod_tpnu"><br>
       <span class="errori">@formerror.cod_tppt;noquote@</span>
       </formerror>
    </td>
</tr>
<tr><td valign=top align=right class=form_title>Descrizione estesa</td>
    ...
    <tr><td valign=top align=right class=form_title>Prefisso</td>
