ad_proc iter-stat-gen {
	...
	ns_log Notice "Inizio della procedura iter-stat-gen-proc"
    
	with_catch error_msg {
	    set nome_file        "Estrazione Statistiche"
		...
		db_foreach sel_database_enti "" {
			if {$nome_database ne ""} {
				with_catch error_msg {
					...
					ns_log Notice "reindirizzamento"
					...
					ns_log Notice "reindirizzamento bis"
					...
					set num_dimp_cait_asso [string trim [set num_dimp_cait_assistal [lindex $res 2]]]
					...
					lappend ritorno $num_dimp_cait_cna $num_dimp_cait_claai $num_dimp_cait_assistal $num_dimp_cait_asso $num_dimp_min_35 $num_dimp_mag_35_min_50 $num_dimp_mag_50_min_116 
		...
		set esit_riga     [list "Scarico Statistiche" $file_csv_url $file_csv]
	    set esit_list     ""
        ...
        ns_log Error "iter_stat_gen-proc: $error_msg"
    }
    
	ns_log Notice "Fine della procedura iter-stat-gen-proc"
    return
