...
<queryset>
    ...
    <fullquery name="iter_inco_cari2.sel_cinc_count">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_cinc">
       <querytext>
                   select cod_cinc
    ...
    <fullquery name="iter_inco_cari2.sel_comu_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_istat_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_comu">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_viae_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_citt_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_dual_cod_cittadino">
       <querytext>
                   select nextval('coimcitt_s') as cod_cittadino
       </querytext>
    </fullquery>

    <fullquery name="iter_inco_cari2.ins_citt">
       <querytext>
                   insert
                     into coimcitt 
                        ( cod_cittadino
    ...
    <fullquery name="iter_inco_cari2.sel_aimp_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_aimp_cod_est_check">
       <querytext>
                   select count(*)              as ctr_aimp
                        , max(cod_impianto_est) as cod_impianto_es
                     from coimaimp
    ...
    <fullquery name="iter_inco_cari2.sel_dual_cod_impianto">
       <querytext>
                   select nextval('coimaimp_s') as cod_impianto
       </querytext>
    </fullquery>

    <fullquery name="iter_inco_cari2.sel_dual_cod_impianto_est">
       <querytext>
    ...
    <fullquery name="iter_inco_cari2.sel_aimp_max_cod_impianto_est">
       <querytext>
                   select coalesce(max(
    ...
    <fullquery name="iter_inco_cari2.ins_aimp">
       <querytext>
                   insert
                     into coimaimp 
                        ( cod_impianto
    ...
    <fullquery name="iter_inco_cari2.ins_gend">
       <querytext>
                   insert
                     into coimgend
                        ( cod_impianto
    ...
    <fullquery name="iter_inco_cari2.sel_citt">
       <querytext>
                   select telefono
                     from coimcitt
    ...
    <fullquery name="iter_inco_cari2.sel_dual_cod_inco">
       <querytext>
                   select nextval('coiminco_s') as cod_inco
       </querytext>
    </fullquery>

    <fullquery name="iter_inco_cari2.ins_inco">
       <querytext>
                   insert
                     into coiminco
                        ( cod_inco
