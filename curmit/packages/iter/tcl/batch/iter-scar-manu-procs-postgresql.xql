...
<queryset>
    ...
    <fullquery name="iter-scar-manu.sel_tabs">
       <querytext>
           select nome_colonna
             from coimtabs
    ...
    <fullquery name="iter-scar-manu.sel_dimp_aimp">
       <querytext>
           select cod_dimp
                , $query_cols
             from coimdimp a
  ...
  left outer join coimcost p on p.cod_cost         = c.cod_cost_bruc
    ...
    <fullquery name="iter-scar-manu.sel_manu">
       <querytext>
    ...
    <fullquery name="iter-scar-manu.sel_anom">
       <querytext>
           select cod_tanom
             from coimanom
