...
<queryset>
    ...
    <fullquery name="iter_inco_cari.sel_cinc_count">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_cinc">
       <querytext>
                   select cod_cinc
    ...
    <fullquery name="iter_inco_cari.sel_comu_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_comu">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_viae_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_citt_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_dual_cod_cittadino">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.ins_citt">
       <querytext>
                   insert
                     into coimcitt 
                        ( cod_cittadino
    ...
    <fullquery name="iter_inco_cari.sel_aimp_check">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_dual_cod_impianto">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_dual_cod_impianto_est">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.sel_aimp_max_cod_impianto_est">
       <querytext>
                   select nvl(max(
    ...
    <fullquery name="iter_inco_cari.ins_aimp">
       <querytext>
                   insert
                     into coimaimp 
                        ( cod_impianto
    ...
    <fullquery name="iter_inco_cari.ins_gend">
       <querytext>
                   insert
                     into coimgend
                        ( cod_impianto
    ...
    <fullquery name="iter_inco_cari.sel_citt">
       <querytext>
                   select telefono
                     from coimcitt
    ...
    <fullquery name="iter_inco_cari.sel_dual_cod_inco">
       <querytext>
    ...
    <fullquery name="iter_inco_cari.ins_inco">
       <querytext>
                   insert
                     into coiminco
                        ( cod_inco
