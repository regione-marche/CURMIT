...
ad_proc -public template::data::validate::integer {
  ...
  if { ! $result } {
#sim01    set message "Invalid integer \"$value\""
      set message "Invalid integer";#sim01
  }
...
ad_proc -public template::data::validate::naturalnum {
  ...
  upvar 2 $message_ref message $value_ref value
    ...
    if { ! $result } {
#sim01    set message "Invalid natural number \"$value\""
	set message "Invalid natural number";#sim01
    }
...
ad_proc -public template::data::validate::float {
  ...
  if { ! $result } {
#sim01    set message "Invalid decimal number \"$value\""
      set message "Invalid decimal number";#sim01
  }
...
ad_proc -public template::data::validate::boolean {
  ...
  switch $value {
      ...
      default {
         set result 0
#sim01         set message "Invalid choice \"$value\""
	  set message "Invalid choice";#sim01
      }
  }
...
ad_proc -public template::data::validate::keyword {
  ...
  if { ! $result } {
#sim01    set message "Invalid keyword \"$value\""
      set message "Invalid keyword";#sim01
  }
...
ad_proc -public template::data::validate::filename {
  ...
  if { ! $result } {
#sim01    set message "Invalid filename \"$value\""
      set message "Invalid filename";#sim01
  }
...
ad_proc -public template::data::validate::email {
  ...
  if { ! $result } {
#sim01    set message "Invalid email format \"$value\""
      set message "Invalid email format";#sim01
  }
...
ad_proc -public template::data::validate::url {
  ...
  if { ! $result } {
#sim01    set message "Invalid url \"$value\""
      set message "Invalid url";#sim01
  }
...
ad_proc -public template::data::validate::url_element {
    ...
    if { ! $result } {
#sim01	set message "Invalid url \"$value\". Please use only lowercase characters, numbers and hyphens, e.g. \"foo-bar\"."
	set message "Invalid url. Please use only lowercase characters, numbers and hyphens, e.g. \"foo-bar\".";#sim01
    }
...
ad_proc -public template::data::validate::number {
  ...
  if { ! $result } {
#sim01    set message "Invalid number \"$value\""
      set message "Invalid number";#sim01
  }
...
ad_proc -public template::data::validate::enumeration {
  ...
  if { ! $result } {
#sim01    set message "Invalid enumeration \"$value\""
      set message "Invalid enumeration";#sim01
    return $result
  }
  ...
  if { ! $result } {
#sim01    set message "Invalid enumeration. \"$value\" does not contain unique values."
      set message "Invalid enumeration. Does not contain unique values.";#sim01
  }  
