ad_page_contract {
    ...
    USER   DATA       MODIFICHE
    ====== ========== =======================================================================
    nic02  25/03/2014 Devo fare un flush della cache altrimenti, quando scade la password
    nic02             e la cambio, openacs non si accorge che l'ho appena cambiata.

    nic01  25/03/2014 In base alla normativa privacy, la password deve essere lunga almeno 8
...
ad_form -extend -name update -form {
    ...
    acs_user::flush_cache -user_id $user_id;#nic02
