ad_page_contract {
    ...
    USER   DATA         MODIFICHE
    ====   ==========  ======================================================
    gab01  27/02/2017  Aggiunte le colonne metodo pagamento e numero fattura
    gab01              e ordinata la lista per numero fattura.
...
#gab01 aggiunte le colonne Mod. Pagamento e Nr. Fattura
append stampa "<center><b>STATISTICA BOLLINI CONSEGNATI</b>
                       <br><br>
                       ...
                       <tr><td width=20%><b>Manutentore</b></td>
                           ...
                           <td width=12%><b>Pagati</b></td>
                           <td width=12%><b>Mod. Pagamento</b></td>
                           <td width=12%><b>Nr. Fattura</b></td>
                       </tr>"
...
db_foreach sel_boll "" {
    ...
    #gab01 aggiunte le colonne per le variabili mod_pag e num_fatt
    append stampa "<tr><td width=20%>$manutentore</td>
                           ...
                           <td width=12%>$pagati</td>
                           <td width=12%>$mod_pag</td>
                           <td width=12%>$num_fatt</td>
