ad_page_contract {
    ...
    USER  DATA       MODIFICHE
    ===== ========== =======================================================================
    gab01 06/03/2017 Controllo che l'importo pagato sia uguale al prodotto del numero bollini e costo unitario.
...
if {$funzione != "I"} {
    ...
    set link_vedi_fatt "nome_funz=[iter_get_nomefunz coimfatt-gest]&$url_boll&[export_url_vars cod_bollini]&funzione=V"
...
if {[form is_valid $form_name]} {
  # form valido dal punto di vista del templating system
    ...
    set cod_fatt           [element::get_value $form_name cod_fatt]
...
imali"
	...
	if {![string equal $imp_pagato ""] && ![string equal $costo_unitario ""] && $sw_costo_unitario_ok eq "t"} {;#gab01 if e suo contenuto
	    set importo_controllo [expr $costo_unitario * $nr_bollini]
	    if {$importo_controllo != $imp_pagato} {
		set importo_controllo [iter_edit_num $importo_controllo 2]
		element::set_error $form_name imp_pagato "il prodotto tra nr bollini e costo unitario è $importo_controllo"
		incr error_num
	    }
	}
    }
	...
	if { $conta_dimp > 0 } {
	    ...
	    #09/03/2017 Copparo vuole cancellare i bollini senza vincoli particolari
	    #if {$pagati == "S"} {
