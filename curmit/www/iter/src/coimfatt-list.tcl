ad_page_contract {
    ...
    USER   DATA         MODIFICHE
    ====   ==========  ======================================================
    gab01  27/02/2017  Cambiata label al campo imponibile_edit
...
#gab01 cambiata label al campo imponibile_edit
#gab01 [list imponibile_edit "Tot. Fatt"       no_sort {l}] \

set table_def [list \
        [list actions         "Azioni"           no_sort $actions] \
    	[list num_fatt        "Numero fattura"   no_sort {l}] \
    	[list nominativo      "Nominativo"       no_sort {l}] \
	[list imponibile_edit "Tot. Fatt"        no_sort {l}] \
